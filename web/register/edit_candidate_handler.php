...
//edit_candidate_handler.php
	...
	$url = "$host/axis2/services/ws_ems/edit_candidate_settings?username=$username&cookie=$cookie_value&ip=$ip&fullname=$newFullname&email=$email&telephone=$tel&obs=$newObs";
	...
	//echo $url;
	$myfile = fopen($url, "r")
       		or die("died when doing OPEN ws_ems.edit_candidate_settings");
	$allLines = "";
