...
<?php 
	...
	echo '<form action="" method="get" name="frmPass" id="frmPass">';
	  ...
	  echo "<tr>\n";
        ...
        echo "</tr>\n";
        echo "<tr>\n";
          echo "<td><input name=\"btnBack\" type=\"button\" id=\"btnBack\" value=\"$backBtnMsg\" onClick=\"back_page('man_candidate.php?user=$username')\"></td>";
          echo "<td><input name=\"btnClear\" type=\"reset\" id=\"btnClear\" value=\"$clearBtnMsg\"></td>";
          echo "<td><input name=\"btnSave\" type=\"button\" id=\"btnSave\" value=\"$saveBtnMsg\" onClick=\"change_candidate_pass()\"></td>";
        echo "</tr>\n";
      echo "</table>\n";
