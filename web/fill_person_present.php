...
<?php 
	...
	echo "<h1>$answerPresenceTitle</h1><br>\n";
			...
			echo '<table width="291" align="center" border="1">';				
				...
				echo "</tr>\n";
						...
						for($i = 0; $i < $cnt ; $i++) {
							...
							if ($i > 0) {
								echo "<tr>\n";
									echo "<td><input type=\"checkbox\" name=\"chkPresence\" value=\"$line[1]\" /></td>";
									echo "<td>$line[0]</td>";
								echo "</tr>\n";
							}						
						}
				...
				echo "<tr>\n";
					...
					echo '<td><input name="btnOk" type="button" value="OK" onClick="answer_presence()"></td>';				
				echo "</tr>\n";
			echo "</table>\n";			
