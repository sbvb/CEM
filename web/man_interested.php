...
<?php
	...
	for($i = 0; $i < $cnt ; $i++) {
		...
		if ($xmlNode !== "false") {		
			...
			echo "<tr>";
			echo "<td><div align=\"center\"><a href=\"view_interested.php?user=$line[0]\">$line[0]</a></div></td>";
			echo "<td><div align=\"center\"><a href=\"edit_interested.php?user=$line[0]\">$editMsg</a></div></td>";			
			echo "<td><div align=\"center\"><a href=\"reset_interested_pass.php?user=$line[0]\">$chgPwdMsg</a></div></td>";
			echo "</tr>";
		}
