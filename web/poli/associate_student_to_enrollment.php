...
<?php
	echo "<h1 align=\"center\">$assocStudEnrTitle</h1>\n";
	echo "<h3 align=\"center\">(\"$programName\",\"$className\")</h3>\n";
	...
	echo "<form name=\"frmAssociate\" id=\"frmAssociate\">\n";
	  echo "<table width=\"400\" border=\"1\" align=\"center\">\n";
		...
		echo "</tr>\n";
		echo "<tr>\n";
			echo "<td align=\"center\"><select name=\"lstSel1\" id=\"lstSel1\" size=\"10\">\n";
			...
			echo "</p></td>\n";
			echo "<td align=\"center\"><select name=\"lstSel2\" id=\"lstSel2\" size=\"10\">\n";
