...
//$fct		= $_REQUEST['fc'];
$signature	= 'admin_man_interested.php';
...
<?php
	echo "<h1 align=\"center\">$manInterestedTitle</h1>\n";
?>  
...
<?php
	  ...
	  echo "<th><div align=\"center\">$datetimeCap[0]</div></th>";
	  echo "<th><div align=\"center\">$admManInterestedCap[1]</div></th>";
...
<?php
	$url = "$host/axis2/services/ws_ems/get_person_list?username=$username&cookie=$cookie_value&ip=$ip&ptype=Interested&sort=date";
	//echo $url;
	$myfile = fopen($url, "r")
	...
	for($i = 0; $i < $cnt ; $i++) {
		...
		if ($i > 0) {		
			...
			if ($i % 2 === 0)
				...
				echo "<tr>";
			$newDate = str_replace("_",":",$line[3]);
			echo "<td><div align=\"center\"><a href=\"admin_view_interested.php?user=$username&pid=$line[1]\">$line[0]</a></div></td>";
			echo "<td><div align=\"center\">$line[2]</div></td>";
			echo "<td><div align=\"center\">$newDate</div></td>";
			echo "<td><div align=\"center\">$line[5]</div></td>";
			echo "<td><div align=\"center\">$line[4]</div></td>";
			echo "<td><div align=\"center\">$line[6]</div></td>";
			echo "<td><div align=\"center\"><a href=\"#\" onclick=\"change_to_candidate('$username','$line[2]')\">$chgCandidateMsg</a></div></td>";
			echo "<td align=\"center\"><a href=\"#\" onClick=\"delete_person_user('$username','$line[2]')\">$delMsg</a></td>\n";
			echo "</tr>";
		}
