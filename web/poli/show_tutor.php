...
<?php
	echo "<h1 align=\"center\">$viewMsg tutor</h1>\n";
	
	$url = "$host/axis2/services/ws_ems/get_tutor_settings?username=$username&cookie=$cookie_value&ip=$ip&pid=$pid";
	$myfile = fopen($url, "r")
       		or die("died when doing OPEN ws_ems.get_tutor_settings");
	$allLines = "";
	...
	$cnt = $xmlElem->length;
	echo "<table border =\"0\" align=\"center\" style=\"background-color:yellow\">\n";
	for($i = 0; $i < $cnt ; $i++) {
