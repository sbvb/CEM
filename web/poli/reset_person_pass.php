...
<?php
	echo "<h1 align=\"center\">$resetPersonPassTitle</h1>\n";
	echo "<p>$curUserMsg $ed_user</p>";
	
	echo '<p><div align="center" id="err_msg" style="color:#FF0000"></div></p>';
	echo '<form action="" method="get" name="frmPass" id="frmPass">';
	  echo '<table width="300" align="center" style="background-color:yellow">';
        echo "<tr>\n";
          echo "<td align=\"right\" width=\"100\">$pwdMsg</td>\n";
          echo '<td colspan="2"><input name="txtPass" type="password" id="txtPass"></td>';
        echo "</tr>\n";
        echo "<tr>\n";
          echo "<td>$pwdConfMsg</td>\n";
          echo '<td colspan="2"><input name="txtPassConf" type="password" id="txtPassConf"></td>';
        echo "</tr>\n";
        echo "<tr>\n";
          echo "<td><input name=\"btnBack\" type=\"button\" id=\"btnBack\" value=\"$backBtnMsg\" onClick=\"back_page('man_person.php?user=$username&fc=2')\"></td>";
          echo "<td><input name=\"btnClear\" type=\"reset\" id=\"btnClear\" value=\"$clearBtnMsg\"></td>";
          echo "<td><input name=\"btnSave\" type=\"button\" id=\"btnSave\" value=\"$saveBtnMsg\" onClick=\"change_person_pass()\"></td>";
        echo "</tr>\n";
      echo "</table>\n";
	  echo "<input type=\"hidden\" name=\"hdOwner\" value=\"$username\">\n";
	  echo "<input type=\"hidden\" name=\"hdEduser\" value=\"$ed_user\">\n";
	echo "</form>\n";
	echo "</div>\n";
?>	
    <!-- Fim Conteúdo -->
