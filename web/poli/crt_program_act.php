...
<?php
	if ($fct == $fct_edit)
	{
		...
		echo "<h1 align=\"center\">$edtProgramActMsg</h1>\n";
		echo "<p>&nbsp; </p>\n";
		...
		echo '<form action="" method="get" name="frmEdit" id="frmEdit">';
			echo '<table width="291" align="center" style="background-color:yellow">';	
				...
				echo "</tr>\n";
				echo "<tr>\n";
					echo "<td align=\"right\"><input name=\"btnBack\" type=\"button\" value=\"$backBtnMsg\" onClick=\"back_page('man_program.php?user=$username&fc=0')\"></td>\n";
					echo "<td align=\"right\"><input name=\"btnSave\" type=\"button\" value=\"$saveBtnMsg\" onClick=\"edit_program()\"></td>";
				echo "</tr>\n";
			echo "</table>\n";
	...
	{		
		echo "<h1 align=\"center\">$crtProgramActMsg</h1>";
		echo '<p><div id="edt_err_msg" align="center" style="color:#FF0000"></div></p>';
