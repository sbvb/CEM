...
?>  
<p>Observação: O contrato deverá ser impresso em frente/verso e em 4 vias</p>
  <table width="500" border="1">
    <tr>
<?php
      echo "<th><div align=\"center\">$usernameRepMsg</div></th>";
	  echo "<th></th>";
...
<?php
	...
	for($i = 0; $i < $cnt ; $i++) {
		...
		if ($xmlNode !== "false") {		
			...
			echo "<tr>";
			echo "<td><div align=\"center\"><a href=\"view_candidate.php?user=$line[0]&uid=$line[2]\">$line[0]</a></div></td>";
			echo "<td><div align=\"center\"><a href=\"edit_candidate.php?user=$line[0]\">$editMsg</a></div></td>";
			//echo "<td><div align=\"center\"><a href=\"download_agreement.php?user=$line[0]\">$downloadAgreementMsg</a></div></td>";
			...
			echo "<td align=\"center\">";
				echo "<form id=\"frmAgreement\" name=\"frmAgreement\" method=\"get\" action=\"\">";
			      	echo "<select name=\"lstAgreement\" id=\"lstAgreement\">";
						echo $agrLst;	
      				echo "</select>";
      				echo "<input type=\"button\" name=\"btnOk\" id=\"btnOk\" value=\"ok\" onclick=\"download_agreement()\" />";
					echo "<input type=\"hidden\" name=\"user\" id=\"user\" value=\"$line[0]\" />";
    			echo "</form>";
			echo "</td>";
			
			echo "<td><div align=\"center\"><a href=\"add_candidate_photo.php?user=$line[0]\">$addPhotoMsg</a></div></td>";
			echo "<td><div align=\"center\"><a href=\"reset_candidate_pass.php?user=$line[0]\">$chgPwdMsg</a></div></td>";
			//echo "<td><div align=\"center\"><a href=\"#\" onclick=\"delete_candidate('$line[0]')\">$delMsg</a></div></td>";
			echo "</tr>";
		}
