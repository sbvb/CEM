...
<?php
	echo "<h1 align=\"center\">$manClassCourseTitle</h1>\n";
		
	echo '<form action="associate_class_course.php" method="get" name="frmCreate" id="frmCreate">';
			echo '<table width="353" align="center" style="background-color:yellow">';
				echo "<tr>\n";
					...
					echo '</select></td>';				
					echo '<td><input name="btnOk" type="submit" id="btnCreate" value="Ok"></td>';
				echo "</tr>\n";
			echo "</table>\n";
