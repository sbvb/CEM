...
<Script Language="JavaScript"> 
	function getCourse(what,user) { 
	   if (what.selectedIndex != '') { 
		  ...
		  document.location=('answer_presence.php?user=' + user + '&coline=' + coline);
		  //alert(class); 
	   } 
	} 
	function getClass(what,user,coline) { 
	   if (what.selectedIndex != '') { 
		  ...
		  document.location=('answer_presence.php?user=' + user + '&coline=' + coline + '&clline=' + clline);
		  //alert(class); 
	   } 
	}
</Script>
...
<?php
	echo "<h1 align=\"center\">$answerPresenceTitle</h1>\n";
		
	echo '<form action="choose_ccdt_presence.php" method="get" name="frmCreate" id="frmCreate">';
