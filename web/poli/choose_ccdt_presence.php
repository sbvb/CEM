...
<?php
	echo "<h1 align=\"center\">$answerPresenceTitle of \"$courseName\",\"$className\",\"$scheduleName\"</h1>\n";
			...
			for($i = 0; $i < $cnt ; $i++) {
				...
				if ($xmlNode !== "") {
					...
					if ($i % 2 === 0)
						...
						echo "<tr>\n";
						echo "<td>\n";							
							echo "<a href=\"fill_person_present.php?user=$username&clname=$className&clid=$classId&coname=$courseName&coid=$courseId&date=$line[1]&time=$line[2]-$line[3]&ccdtid=$line[0]\">$line[1]</a>";																			
						echo "</td>\n";
						echo "<td>\n";
							echo "$line[2]-$line[3]";																			
						echo "</td>\n";
						echo "<td>\n";							
							echo "<a href=\"comment_event.php?user=$username&clname=$className&clid=$classId&coname=$courseName&coid=$courseId&date=$line[1]&time=$line[2]-$line[3]&ccdtid=$line[0]\">$addCommentsMsg</a>";																			
						echo "</td>\n";
