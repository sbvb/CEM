...
<?php
	echo "<h1 align=\"center\">$manProgCourseTitle</h1>\n";
		
	echo '<form action="associate_prog_course.php" method="get" name="frmCreate" id="frmCreate">';
			echo '<table width="353" align="center" style="background-color:yellow">';
				echo "<tr>\n";
					...
					echo '</select></td>';				
					echo '<td><input name="btnOk" type="submit" id="btnOk" value="Ok"></td>';
				echo "</tr>\n";
			echo "</table>\n";
