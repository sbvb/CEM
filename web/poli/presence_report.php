...
<Script Language="JavaScript"> 
	function getCourse(what,user) { 
	   if (what.selectedIndex != '') { 
		  ...
		  document.location=('presence_report.php?user=' + user + '&coline=' + coline);
		  //alert(class); 
	   } 
	} 
	function getClass(what,user,coline) { 
	   if (what.selectedIndex != '') { 
		  ...
		  document.location=('presence_report.php?user=' + user + '&coline=' + coline + '&clline=' + clline);
		  //alert(class); 
	   } 
	}
</Script>
...
<?php
	...
	echo '<form action="choose_ccdt_presence_rep.php" method="get" name="frmCreate" id="frmCreate">';
