...
<Script Language="JavaScript"> 
	function getCourse(what,user) { 
	   if (what.selectedIndex != '') { 
		  ...
		  document.location=('presence_map_report.php?user=' + user + '&coline=' + coline);
		  //alert(class); 
	   } 
	} 
	function getClass(what,user,coline) { 
	   if (what.selectedIndex != '') { 
		  ...
		  document.location=('presence_map_report.php?user=' + user + '&coline=' + coline + '&clline=' + clline);
		  //alert(class); 
	   } 
	}
</Script>
...
<?php
	echo "<h1 align=\"center\">$presMapRepTitle</h1>\n";
		
	echo '<form action="show_presence_map_rep.php" method="get" name="frmCreate" id="frmCreate">';
