...
<?php
	echo "<h1 align=\"center\">$viewInterestedTitle</h1>\n";
?>  
  <!-- <div align="center">b</div> -->
  <form action="" method="post" name="frmCreate" id="frmCreate">
    <table width="200" border="0" style="background-color:yellow" align="center">      
      <tr>        
<?php
...
?>
      ...
      <td><div align="center">
<?php       
        echo "<input name=\"btnBack\" type=\"button\" id=\"btnBack\" value=\"$backBtnMsg\" onClick=\"back_page('admin_man_interested.php?user=$username')\">";
?>		
      </div></td>
      </tr>
    </table>    
