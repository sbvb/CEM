...
<?php
	echo "<h1 align=\"center\">$assocClassCourseTitle \"$className\"</h1>\n";
	
	echo "<table width=\"400\" border=\"1\" align=\"center\">\n";
		echo "<tr>\n";
		  echo "<th width=\"200\">$assocClassCourseCap[0]</td>\n";
		  echo "<th width=\"200\">$assocClassCourseCap[1]</td>\n";
		echo "</tr>\n";
		
			$url = "$host/axis2/services/ws_ems/get_courses_class_list?username=$username&cookie=$cookie_value&ip=$ip&cid=$classId";
			//echo "url = $url<br>";
			$myfile = fopen($url, "r")
					or die("died when doing OPEN ws_ems.get_courses_class_list");
			$allLines = "";
			...
			for($i = 0; $i < $cnt ; $i++) {
				...
				if ($i > 0) {
					if ($i % 2 === 0)
						...
						echo "<td>\n";							
							echo "<a href=\"fill_class_course.php?user=$username&clname=$className&clid=$classId&coname=$line[0]&coid=$line[1]&manok=$line[2]\">$line[0]</a>";																			
						echo "</td>\n";
						echo "<td align=\"center\">\n";
							if ($line[2] == 0)
								echo "<img src=\"img/no_checked.jpg\">";
							else
