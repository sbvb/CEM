...
<?php
	echo "<h1 align=\"center\">$presenceReportTitle</h1>\n";
	...
	echo '<table width="291" align="center" border="1">';				
		...
		echo "</tr>\n";
			...
			$url = "$host/axis2/services/ws_ems/show_presence_report?username=$username&cookie=$cookie_value&ip=$ip&coid=$courseId&clid=$classId&ccdtid=$ccdtid";
			//echo "url = $url<br>";
			$myfile = fopen($url, "r")
			...
			for($i = 0; $i < $cnt ; $i++) {
				...
				if ($i > 0) {
					if ($i % 2 === 0)
						...
						echo "<td>$line[0]</td>";
						if ($line[1] == "1")
							echo "<td align=\"center\"><img src=\"img/checked.png\" /></td>";
						else
							echo "<td align=\"center\"><img src=\"img/no_checked.jpg\" /></td>";
					echo "</tr>\n";
				}						
			}								
