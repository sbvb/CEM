...
$url = "$host/axis2/services/ws_ems/get_user_payment_settings?username=$username&cookie=$cookie_value&ip=$ip&pid=$pid";
//echo $url;
$myfile = fopen($url, "r")
		or die("died when doing OPEN ws_ems.get_user_payment_settings");
$allLines = "";
...
<?php
        ...
        echo "<td colspan=\"2\">$nick</td>";
?>
      </tr>
	<tr>                  
<?php
		echo "<td><div align=\"right\">$fullnameMsg</div></td>";
        echo "<td colspan=\"2\">$regSettings[0]</td>";
?>
      </tr>
      <tr>
<?php
		echo "<td><div align=\"right\">$descValueMsg:</div></td>";
        echo "<td colspan=\"2\"><input name=\"txtDescValue\" type=\"text\" id=\"txtDescValue\" value=\"$regSettings[1]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$descQuotaMsg:</div></td>";
		echo "<td colspan=\"2\"><input name=\"txtDescQuota\" type=\"text\" id=\"txtDescQuota\" value=\"$regSettings[2]\"></td>";
?>
      </tr>
      <tr>
	  	<td><div align="center">
...
?>			
      	...
      	<td><div align="center">
<?php		
        	echo "<input name=\"btnSave\" type=\"button\" id=\"btnSave\" value=\"$saveBtnMsg\" onClick=\"set_payment()\">";
?>			
      	</div></td>
      </tr>
    </table>
<?php
	...
	echo "<input name=\"hdPid\" type=\"hidden\" id=\"hdPid\" value=\"$pid\">";
?>
  </form>
  </div>
  <p>&nbsp;  </p>
