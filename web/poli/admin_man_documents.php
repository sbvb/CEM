...
<?php
	echo "<h1 align=\"center\">$manDocumentsTitle</h1>\n";
	echo "$curUserMsg $nick";
?>  
...
<?php
	$url = "$host/axis2/services/ws_ems/get_documents_from_candidate?username=$username&cookie=$cookie_value&ip=$ip&pid=$pid";
	//echo $url;
	$myfile = fopen($url, "r")
			or die("died when doing OPEN ws_ems.get_documents_from_candidate");
	$allLines = "";
	...
	for($i = 0; $i < $cnt ; $i++) {
		...
		if ($xmlNode !== "false") {
			...
			if ($i %  2 === 0)
				...
				echo "<tr>";				
			if ($line[2] === "pdf") {		
				echo "<td><div align=\"center\"><a href=\"admin_download_document.php?user=$username&pid=$pid&fid=$line[1]&ext=$line[2]&desc=$line[3]\"><img src=\"img/pdf.png\" width=\"100\" height=\"100\" /></a></div></td>";			
			} else		
				echo "<td><div align=\"center\"><a href=\"admin_download_document.php?user=$username&pid=$pid&fid=$line[1]&ext=$line[2]&desc=$line[3]\"><img src=\"admin_photo.php?user=$username&pid=$pid&fid=$line[1]\" width=\"100\" height=\"100\" /></a></div></td>";
			...
			echo "<td><div align=\"center\"><a href=\"#\" onclick=\"admin_delete_document('$username','$line[1]', '$line[2]')\">$delMsg</a></div></td>";
			echo "</tr>";
		}		
