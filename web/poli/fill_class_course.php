...
<?php
	echo "<h1 align=\"center\">$fillClCoTitle</h1><br>\n";
	echo "<h3 align=\"center\">($assocClassCourseCap[0] \"$courseName\", $assocClassCourseCap[2] \"$className\")</h1>\n";
				...
				echo '<table width="291" align="center" style="background-color:yellow">';				
					...
					echo "<tr>\n";
						...
						echo '<td><select name="lstTutor" id="lstTutor">';
							...
							$url = "$host/axis2/services/ws_ems/get_person_list?username=$username&cookie=$cookie_value&ip=$ip&ptype=Tutor&sort=name";
							//echo $url;
							$myfile = fopen($url, "r")
