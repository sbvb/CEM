...
<Script Language="JavaScript"> 
		function getProgram(what,user) { 
		   if (what.selectedIndex != '') { 
			  ...
			  document.location=('man_enrollment.php?user=' + user + '&pline=' + pline);
			  //alert(class); 
		   } 
		}		
		function getClass(what,user,pline) { 
		   if (what.selectedIndex != '') { 
			  ...
			  document.location=('man_grade.php?user=' + user + '&pline=' + pline + '&clline=' + clline);
			  //alert(class); 
		   } 
		}
</Script>
...
<?php
	echo "<h1 align=\"center\">$manEnrollmentTitle</h1>\n";
		
	echo '<form action="associate_student_to_enrollment.php" method="get" name="frmCreate" id="frmCreate">';
