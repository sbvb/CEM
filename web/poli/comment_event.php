...
<?php
	echo "<h1 align=\"center\">$commentEventTitle</h1><br>\n";
	...
	echo '<p><div id="edt_err_msg" align="center" style="color:#FF0000"></div></p>';
		echo '<form action="" method="get" name="frmAssociate" id="frmCreate">';
			echo '<table width="291" align="center" border="0" style="background-color:yellow">';				
				echo "<tr>\n";				
				...
				echo "<tr>\n";
					...
					echo '<td align="right"><input name="btnOk" type="button" value="OK" onClick="comment_event()"></td>';				
				echo "</tr>\n";
			echo "</table>\n";			
