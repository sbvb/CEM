...
<div align="center">
<?php
	echo "<h1>$editCandidateTitle</h1>\n";
?>  
  <!-- <div align="center">b</div> -->
  <div align="center" class="style1" id="edt_err_msg" style="color:red"></div>
  <form action="" method="post" name="frmEdit" id="frmEdit">
    <table width="300" style="background-color:yellow">
      <tr>
<?php
...
<?php
		...
		if ($regSettings[4] === "-")
			...
			echo "<td colspan=\"2\"><input name=\"txtTelephone\" type=\"text\" id=\"txtTelephone\" value=\"$regSettings[4]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$addressMsg:</div></td>";		
       	echo "<td colspan=\"2\"><input name=\"txtAddress\" type=\"text\" id=\"txtAddress\" value=\"$regInformation[0]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$districtMsg:</div></td>";		
       	echo "<td colspan=\"2\"><input name=\"txtDistrict\" type=\"text\" id=\"txtDistrict\" value=\"$regInformation[1]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$cityMsg:</div></td>";		
       	echo "<td colspan=\"2\"><input name=\"txtCity\" type=\"text\" id=\"txtCity\" value=\"$regInformation[2]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$stateMsg:</div></td>";		
       	echo "<td colspan=\"2\"><input name=\"txtState\" type=\"text\" id=\"txtState\" value=\"$regInformation[3]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$zipCodeMsg:</div></td>";		
       	echo "<td colspan=\"2\"><input name=\"txtZipCode\" type=\"text\" id=\"txtZipCode\" value=\"$regInformation[4]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$civilStatusMsg:</div></td>";		
       	echo "<td colspan=\"2\"><input name=\"txtCivilStatus\" type=\"text\" id=\"txtCivilStatus\" value=\"$regInformation[5]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$careerMsg:</div></td>";		
       	echo "<td colspan=\"2\"><input name=\"txtCarrer\" type=\"text\" id=\"txtCareer\" value=\"$regInformation[6]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">$identityMsg:</div></td>";		
       	echo "<td><input name=\"txtIdentity\" type=\"text\" id=\"txtIdentity\" value=\"$regInformation[7]\"></td>";
		echo "<td>$issuedByMsg:<input name=\"txtIssuedBy\" type=\"text\" id=\"txtIssuedBy\" size=\"5\" value=\"$regInformation[8]\"></td>";
?>
      </tr>
	  <tr>        
<?php
		echo "<td><div align=\"right\">cpf:</div></td>";		
       	echo "<td colspan=\"2\"><input name=\"txtCpf\" type=\"text\" id=\"txtCpf\" value=\"$regInformation[9]\"></td>";
?>
      </tr>
	  <tr>        
<?php
...
?>			
      	...
      	<td><div align="center">
<?php		
        	echo "<input name=\"btnSave\" type=\"button\" id=\"btnSave\" value=\"$saveBtnMsg\" onClick=\"edit_candidate_act()\">";
?>			
      	</div></td>
      </tr>
    </table>
