...
$fileDir = "http://www.cloudeducationmanagement.com/upload/";
...
<div align="center">
  <p>
    <?php
	echo "<h1>$addCandidatePhotoTitle</h1>\n";
?>  
 </p>
  <p align="left"> clique na foto para fazer upload  <!-- <div align="center">b</div> -->
  </p>
...
<?php
	if ($photoProperties[0] === "false")
	  	echo "<td width=\"125\"><img src=\"img/no_image_male.gif\" width=\"125\" height=\"125\" onClick=\"open_upload('$username')\"></td>";
	else { // load the image from user		
		echo "<td width=\"125\"><img src=\"photo.php?user=$username&fid=$photoProperties[1]\" width=\"125\" height=\"125\" onClick=\"open_upload('$username')\"></td>";		
	}
