...
<Script Language="JavaScript"> 
	function getCourse(what,user) { 
	   if (what.selectedIndex != '') { 
		  ...
		  document.location=('stat_presence_report.php?user=' + user + '&coline=' + coline);
		  //alert(class); 
	   } 
	} 
	function getClass(what,user,coline) { 
	   if (what.selectedIndex != '') { 
		  ...
		  document.location=('stat_presence_report.php?user=' + user + '&coline=' + coline + '&clline=' + clline);
		  //alert(class); 
	   } 
	}
</Script>
...
<?php
	...
	echo '<form action="show_stat_presence_report.php" method="get" name="frmCreate" id="frmCreate">';
