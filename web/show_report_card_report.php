...
//$fct		= $_REQUEST['fc'];
$signature	= 'show_report_card_report.php';
...
<?php 
	...
	echo "<h1>$reportCardReportTitle</h1><br>\n";
	...
	echo '<table width="291" align="center" border="1">';				
		...
		echo "</tr>\n";
			...
			//Getting the report card report from webservices
			$url = "$host/axis2/services/ws_ems/show_report_card_report?username=$username&cookie=$cookie_value&ip=$ip";
			//echo "url = $url<br>";
			$myfile = fopen($url, "r")
