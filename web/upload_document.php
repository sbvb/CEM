...
?>
<body>
<form action="upload_process.php" method="post" enctype="multipart/form-data" name="frmUpload" id="frmUpload">
<?php  
  echo "<p align=\"center\">$uploadDocumentTitle</p>";
?>
  <div align="center">
    <table width="304" border="1">
      <tr>
<?php      
        echo "<td width=\"70\"><div align=\"right\">$uploadPhotoCap[0]: </div></td>";
?>		
      ...
      <tr>
<?php
        echo "<td><div align=\"right\">$uploadPhotoCap[1]:</div></td>";
?>		
        <td><div align="center">
...
<?php  
  ...
  echo "<input name=\"lstPermission\" type=\"hidden\" id=\"lstPermission\" value=\"private\">";
?>
</form>
</body>
</html>
