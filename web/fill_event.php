	...
	echo '<p><div id="edt_err_msg" style="color:#FF0000"></div></p>';
		echo '<form action="" method="get" name="frmAssociate" id="frmCreate">';
			echo '<table width="291" align="center">';				
				...
				echo "</tr>\n";	
				echo "<tr>\n";
					echo "<td><input name=\"btnBack\" type=\"button\" value=\"$backBtnMsg\" onClick=\"back_page('man_event.php?user=$username')\"></td>";
					echo '<td><input name="btnOk" type="button" value="OK" onClick="associate_event()"></td>';				
				echo "</tr>\n";
			echo "</table>\n";			
			...
			echo "<input type=\"hidden\" name=\"hdDateId\" value=\"$dateId\">\n";
		echo "</form>\n";	
	echo "</center>\n";
?>
</body>
