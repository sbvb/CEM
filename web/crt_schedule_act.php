...
<?php 
	...
	if ($fct == $fct_edit)
	{		
		$url = "$host/axis2/services/ws_ems/get_schedule_settings?username=$username&cookie=$cookie_value&ip=$ip&schid=$edt_usr";
		//echo $url;
		$myfile = fopen($url, "r")
		...
		echo "<h1>$edtScheduleActMsg</h1>\n";
		echo "<p>&nbsp; </p>\n";
		echo "<p>$curScheduleMsg: $name</p>\n";
		echo '<p><div id="edt_err_msg" style="color:#FF0000"></div></p>';
		echo '<form action="" method="get" name="frmEdit" id="frmEdit">';
			echo '<table width="291" align="center" class="specialtable">';				
				echo "<tr>\n";
					echo '<td><div align="right">Schedule: </div></td>';
					echo '<td colspan="2"><input name="txtSchedule" type="text" id="txtSchedule" value="' . $name . '"></td>';
				echo "</tr>\n";								
				echo "<tr>\n";
					echo "<td><input name=\"btnBack\" type=\"button\" value=\"$backBtnMsg\" onClick=\"back_page('man_schedule.php?user=$username&fc=0')\"></td>";
					echo "<td><input name=\"btnSave\" type=\"button\" value=\"$saveBtnMsg\" onClick=\"edit_schedule()\"></td>";
				echo "</tr>\n";
			echo "</table>\n";
	...
	{		
		echo "<h1>$crtScheduleActMsg</h1>";
		echo '<p><div id="edt_err_msg" style="color:#FF0000"></div></p>';
		echo '<form action="" method="get" name="frmCreate" id="frmCreate">';
			echo '<table width="353" align="center" class="specialtable">';
				echo "<tr>\n";
					echo "<td><div align=\"right\">$scheduleCap:</div></td>";
					echo '<td colspan="2"><input name="txtSchedule" type="text" id="txtSchedule"></td>';
				echo "</tr>\n";											
				echo "<tr>\n";
					echo "<td><input name=\"btnBack\" type=\"button\" id=\"btnBack\" value=\"$backBtnMsg\" onClick=\"back_page('man_schedule.php?user=$username&fc=0')\"></td>";
					echo "<td><input name=\"btnClear\" type=\"reset\" id=\"btnClear\" value=\"$clearBtnMsg\"></td>";
					echo "<td><input name=\"btnCreate\" type=\"button\" id=\"btnCreate\" value=\"$createBtnMsg\" onClick=\"create_schedule()\"></td>";
				echo "</tr>\n";
			echo "</table>\n";
			echo "<input type=\"hidden\" name=\"hdOwner\" value=\"$username\">\n";
		echo "</form>\n";
