	...
	<Script Language="JavaScript"> 
		function getProgram(what,user) { 
		   if (what.selectedIndex != '') { 
			  ...
			  document.location=('man_grade.php?user=' + user + '&pline=' + pline);
			  //alert(class); 
		   } 
		}
		function getCourse(what,user,pline) { 
		   if (what.selectedIndex != '') { 
			  ...
			  document.location=('man_grade.php?user=' + user + '&pline=' + pline + '&coline=' + coline);
			  //alert(class); 
		   } 
		} 
		function getClass(what,user,pline,coline) { 
		   if (what.selectedIndex != '') { 
			  ...
			  document.location=('man_grade.php?user=' + user + '&pline=' + pline + '&coline=' + coline + '&clline=' + clline);
			  //alert(class); 
		   } 
		}
	</Script>
...
<?php 
	...
	echo '<form action="associate_student_to_grade.php" method="get" name="frmCreate" id="frmCreate">';
