...
function login_receive(responseText) {
	...
	{
		document.getElementById("loginErrMsg").innerHTML = "Logged succesfull";
	...
	{
		document.getElementById("loginErrMsg").innerHTML = "login/password invalid";
	}
	//alert(responseText);
}
...
function create_person_user() {
	...
	if (nickname == "") {
		document.getElementById("edt_err_msg").innerHTML = "nickname is required";	
		...
		document.getElementById("edt_err_msg").innerHTML = "password is required";
		document.frmCreate.txtPass.focus();
	}
	else if (passConf == "") {
		document.getElementById("edt_err_msg").innerHTML = "password confirmation is required";
		...
		if (pass != passConf) { //passwords must be the same
			document.getElementById("edt_err_msg").innerHTML = "Passwords must be the same";
...
function create_person_user_receive(responseText) {
	...
	if (responseText == "true") { //user created
		...
		document.getElementById("edt_err_msg").innerHTML = "User already exists";
	}
...
function change_person_pass_receive(responseText) {
	...
	if (line[0] == "true") {
		...
		document.getElementById("err_msg").innerHTML = "password can't be changed";
	}
}
...
function edit_person_user_receive(responseText) {
	...
	if (line[0] == "true") {
		...
		document.getElementById("edt_err_msg").innerHTML = "user can't be edited";
	}
}
...
function create_candidate_receive(responseText) {
	if (responseText == "true") {
		...
		document.getElementById('edt_err_msg').innerHTML = "Could not register candidate, email already used";
	}
	else if (responseText == "err_user_id_exists"){
		document.getElementById('edt_err_msg').innerHTML = "Could not register candidate, user id already used";
	}
	else {
		document.getElementById('edt_err_msg').innerHTML = "Could not register candidate, an error occurred";
	}
