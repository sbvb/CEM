...
<?php 
	...
	echo "<h1>$presenceReportTitle \"$courseName\",\"$className\",\"$scheduleName\"</h1>\n";
	...
	echo "<table width=\"400\" border=\"1\">\n";
		...
		echo "</tr>\n";
			...
			for($i = 0; $i < $cnt ; $i++) {
				...
				echo "<tr>\n";	 
					echo "<td>\n";							
						echo "<a href=\"show_presence_report.php?user=$username&clname=$className&clid=$classId&coname=$courseName&coid=$courseId&date=$line[1]&time=$line[2]-$line[3]&ccdtid=$line[0]\">$line[1]</a>";																			
					echo "</td>\n";
					echo "<td>\n";
						echo "$line[2]-$line[3]";																			
					echo "</td>\n";
